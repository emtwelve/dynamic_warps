...
g++ -m64 -O3 -Wall -o log_$1 objs/anno_$1.o -L/usr/local/cuda/lib64/ -lcudart
./log_$1
...
./remap_warp $2 $3 $4 > warp.log

echo -e "\e[0;49;96m" # Cyan
echo "Run unoptimized code"
nvcc unopt_$1.cu -O3 -m64 --gpu-architecture compute_35 -c -o objs/unopt_$1cu.o
g++ -m64 -O3 -Wall -o unopt_$1 objs/unopt_$1.o -L/usr/local/cuda/lib64/ -lcudart
./unopt_$1
